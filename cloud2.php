...
<html lang="en">
    ...
    <?php
    include 'connect.php';
    $sql="SELECT json FROM `userselecturlset` ORDER BY set_id DESC LIMIT 1";
...
<div class="subnav">
   <ul class="navi">
                        ...
                        <li class="side active"><a href="search.php">網址分析</a></li>
...
<div class="ui small steps">
 ...
 <!--  <div class="step">
    <img src="checked.png">
    <div class="content">
      <div class="title">step3<br>&nbsp;&nbsp;分析資料</div>
    </div>
  </div> -->
  <div class="active step">
    ...
    <div class="content">
      <div class="title">step3<br>&nbsp;&nbsp;產生文字雲</div>
            ...
            <div id="wordCloud" style="width:600px;height:550px;border:thin solid #DBDBDB;background-color:#DBDBDB">
            </div>
            <br><br>
        </div>
        <div id="clear"></div>
